        ...
        if (!posts.length) {
            ...
            <li class="relative px-4 py-5 bg-white gap-y-4 flex flex-col">
                ...
                <div class="flex gap-4">
                   ...
                   <a href="/edit-post.html?post_id=${posts[i].id}" class="inline-flex items-center rounded-md border border-transparent bg-yellow-100 px-3 py-2 text-sm font-medium leading-4 text-yellow-700 hover:bg-yellow-300 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2">
                      Edit
                   </a> 
                </div>
            </li>
